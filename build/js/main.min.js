...
exports.tabs = exports.initTabs = exports.initAccordions = exports.accordions = void 0;
...
// eslint-disable-next-line no-new
new _swiper.default('.trainers__container', {
  observer: true,
  slidesPerView: 4,
  loop: true,
  spaceBetween: 44,
...
function setupVideo() {
  ...
  var videoPrev = video.querySelector('.video__wrapper');
...
},{"../js/vendor/swiper":4,"./accordions":1,"./tabs":3}],3:[function(require,module,exports){
"use strict";
